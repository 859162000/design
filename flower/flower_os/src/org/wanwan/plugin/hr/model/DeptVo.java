...
public class DeptVo implements java.io.Serializable, Comparable, SqlVo {
	...
	public String toName() {
		String sqlName = this.chinaName + "(" + this.name + ")";
		return sqlName;
	}
	...
	public String toUpdate() {
		//组装更新的sql语句
		String sql = "update t_dept set code='"+this.code+"',"
				+ "name='"+this.toName()+"',"
