...
public class SendMail {
	...
	public static void main(String[] args) {
		...
		sendmail.setUserName("lironghai_1988@163.com");//您的邮箱用户名
		sendmail.setPassWord("chengzhi233");//您的邮箱密码
		sendmail.setTo("632468635@qq.com");//接收者
		sendmail.setFrom("lironghai_1988@163.com");//发送者
		sendmail.setSubject("this" + Math.random());
		sendmail.setContent("this, welcome thank you!" + Math.random());
		sendmail.attachfile("E:\\quick\\english.zip");
		sendmail.sendMail();
		System.out.println("...");
	}
}// end